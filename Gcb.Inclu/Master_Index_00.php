...
if ($_SESSION['dni'] == $_SESSION['mydni']) {
	...
	<li>
		<a href='#'><i class='ic ico22'></i> <span>WEB MASTER</span></a>
			<ul class='nav-flyout'>
		<li><a href='Gcb.upbbdd/export_bbdd_backups.php'><i class='ic ico22'></i>BACKUP bbdd</a></li>
	...
	<li>
		<a href='#'><i class='ic ico13'></i> <span>USUARIOS</span></a>
			<ul class='nav-flyout'>
				...
				<li>
					<a href='Admin_Ver.php'><i class='ic ico15b'></i>CONSULTAR</a>
				</li>
				<li>
					<a href='Admin_Crear.php'><i class='ic ico14b'></i>CREAR</a>
				</li>
				<li>
					<a href='Admin_Modificar_01.php'><i class='ic ico02b'></i>MODIFICAR</a>
				</li>
				<li>
					<a href='Admin_Borrar_01.php'><i class='ic ico19b'></i>BORRAR</a>
				</li>
	...
	<li>
		<a href='#'><i class='ic ico13'></i> <span>ARTICULOS/span></a>
			<ul class='nav-flyout'>
				<li><a href='#' style='background-color: #343434;'></a></li>
				<li>
	...
	<li>
		<a href='#'><i class='ic ico03'></i> <span>RESPALDO DATOS</span></a>
			<ul class='nav-flyout'>
				...
				<li>
					<a href='Gcb.upbbdd/export_res_mes.php'><i class='ic ico02b'></i>HORARIOS .txt</a>
				</li>
				<li>
					<a href='Gcb.upbbdd/bbdd.php'><i class='ic ico02b'></i>TABLAS bbdd</a>
				</li>
				<li>
					<a href='Gcb.upbbdd/export_log.php'><i class='ic ico02b'></i>SYSTEM .log</a>
				</li>
				<li><a href='#' style='background-color: #343434;padding-bottom: 29px;'></a></li>
			</ul>
	</li>
...
<ul>
			...
			<li>
				<a href='Admin/Admin_Modificar_01.php'><i class='ic ico13'></i>MIS DATOS</a>
			</li>
	
	<li>
		<a href='#'><i class='ic ico12'></i> <span>FICHAR IN / OUT</span></a>
			<ul class='nav-flyout'>
				<li><a href='#' style='background-color: #343434;'></a></li>
				<li>
					<a href='fichar/fichar_Crear.php'><i class='ic ico13'></i>FICHAR YO</a>
				</li>
				<li>
					<a href='fichar/fichar_Ver.php'><i class='ic ico15b'></i>CONSULTA YO</a>
				</li>
				<li>
					<a href='fichar/fichar_Crear_otr.php'><i class='ic ico02b'></i>FICHAR otros</a>
				</li>
				<li>
					<a href='fichar/fichar_Ver_otr.php'><i class='ic ico15b'></i>CONSULTA otr</a>
				</li>
				<li><a href='#' style='background-color: #343434;padding-bottom: 56px;'></a></li>
			</ul>
	</li>
	...
	<li>
		<a href='#'><i class='ic ico12'></i> <span>FICHAR IN / OUT</span></a>
			<ul class='nav-flyout'>
				...
				<li><a href='#' style='background-color: #343434;padding-bottom: 112px;'></a></li>
			</ul>
	</li>
