	...
	<li>
		<a href='#'><i class='ic ico02'></i> <span>ARTICULOS</span></a>
			<ul class='nav-flyout'>
				...
				<li>
					<a href='Articulo_Ver.php'><i class='ic ico15b'></i>CONSULTAR</a>
				</li>
				<li>
					<a href='Articulo_Crear.php'><i class='ic ico14b'></i>CREAR</a>
				</li>
				<li>
					<a href='Articulo_Modificar_01.php'><i class='ic ico02b'></i>MODIFICAR</a>
				</li>
				<li>
					<a href='Articulo_Borrar_01.php'><i class='ic ico19b'></i>BORRAR</a>
				</li>
				<li><a href='#' style='background-color: #343434;padding-bottom: 56px;'></a></li>
			</ul>
	</li>
