...
$campo = 'id,refuser,refart,tit,titsub,datein,timein,datemod,timemod,conte,myimg';
$texc = '`id`, `refuser`, `refart`, `tit`, `titsub`, `datein`, `timein`, `datemod`, `timemod`, `conte`, `myimg`';
		$id = "`id`";
