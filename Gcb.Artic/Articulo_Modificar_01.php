...
function process_form(){
	...
	<form name='ver' action='Articulo_Modificar_02.php' method='POST'>
	...
	<img src='../Gcb.Img.Art/".$rowc['myimg']."'  width='70%' height='auto' />
						</td>
	...
	<form name='modifica_img' action='Articulo_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup',  'width=540px, height=auto')\">

			<input name='id' type='hidden' value='".$rowc['id']."' />
			<input name='dyt1' type='hidden' value='".$dyt1."' />
			<input name='refuser' type='hidden' value='".$rowc['refuser']."' />
			<input name='refart' type='hidden' value='".$rowc['refart']."' />
...
function ver_todo(){
	...
	*/
	...
	<img src='../Gcb.Img.Art/".$rowb['myimg']."'  width='70%' height='auto' />
						</td>
